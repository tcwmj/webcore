	...
	public Locator locator(String id, String... replacements) {
		...
		if (locator != null) {
			...
			for (int i = 0; i < replacements.length; i++) {
				int index = locator.getExpression().indexOf(org.yiwan.webcore.util.PropHelper.REPLACEMENT_SYMBOL);
				locator.setExpression(locator.getExpression().substring(0, index) + replacements[i]
						+ locator.getExpression().substring(index + 1));
			}
		}
		return locator;
	}
